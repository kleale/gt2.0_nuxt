  ...
  shadow-sm">
    ...
    <div class="navbar-end gap-2 lg:w-auto px-3 lg:px-4">
      ...
      <div class="dropdown dropdown-end hidden lg:block rounded">
        <div tabindex="0" role="button" class="btn btn-xs text-primary rounded hover:bg-primary hover:border-primary hover:text-black">RU</div>
      ...
      <label name="swap-theme" class="swap swap-rotate hidden lg:inline-grid">
        ...
        <input id="swap" type="checkbox" class="theme-controller" value="synthwave" />
        <!-- sun icon -->
